...
@set SOURCES=main.cpp glad.c i_input.cpp math_utils.cpp scene_parser.cpp GameStates/MainState.cpp Graphics/GLShader.cpp  Graphics/GLTextRenderer.cpp Graphics/GLMesh.cpp Graphics/GLTexture.cpp player.cpp GAME_main.cpp game_state.cpp g_main.cpp r_main.cpp utils.cpp 
